...
export const GetPreloadImagesContext = createContext<PreloadQueueContext['getImages'] | null>(null);
...
export const GetPreloadImagesProvider: React.FC<GetPreloadImagesProviderProps> = ({
  children,
  getImages,
}) => {
  return (
