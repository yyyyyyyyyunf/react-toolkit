...
import { FeatureConfigMap, FeatureDetectorOptions } from "../types";
 ...
 * ```
 */
export function createFeatureDetector(config: FeatureConfigMap=defaultFeatureConfigs, detectorConfig: FeatureDetectorOptions=defaultDetectorConfig): FeatureDetector {
