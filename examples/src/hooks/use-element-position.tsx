				...
				>
					...
					>
						...
						<div style={{ fontSize: "12px", fontFamily: "monospace" }}>
							...
							<div>
								位置: ({formatPosition(position1).left},{" "}
					...
					>
						...
						<div style={{ fontSize: "12px", fontFamily: "monospace" }}>
							...
							<div>
								位置: ({formatPosition(position2).left},{" "}
					...
					>
						...
						<div style={{ fontSize: "12px", fontFamily: "monospace" }}>
							...
							<div>
								状态:{" "}
								{formatPosition(position3).isIntersecting
									? "✅ 可见"
									: "❌ 不可见"}
							</div>
						</div>
						...
						>
							{[
								...
								<div key={name} style={{ marginBottom: "10px" }}>
									<strong>{name}:</strong>{" "}
									{pos
										? JSON.stringify(formatPosition(pos), null, 2)
										: "未检测到"}
								</div>
							))}
						</div>
				...
				>
					...
					>
						<div style={{ textAlign: "center" }}>
							...
							{position3 && (
								<div
									style={{ fontSize: "12px", marginTop: "5px", opacity: 0.8 }}
								>
