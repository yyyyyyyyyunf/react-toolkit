...
export const UseElementDetectorExample: React.FC = () => {
  ...
  return (
    <div className="example-container">
      ...
      <p>展示 useElementDetector Hook 的使用方法，支持默认贴顶检测和自定义条件检测。</p>
      ...
      <div className="demo-section">
        ...
        <div className="info-section">
          ...
          <ul>
            ...
            <li>
              <strong>智能位置同步：</strong>支持 forceCalibrate 和 calibrateInterval 配置
            </li>
            <li>
              <strong>细致配置：</strong>支持
              step、threshold、throttle、forceCalibrate、calibrateInterval、offset 等配置选项
            </li>
            <li>
...
const isInCenter = useElementDetector(ref, {
  ...
  calibrateInterval: 3000, // 校准间隔 3 秒
      ...
      >
        <div style={{ padding: '20px', textAlign: 'center' }}>向下滚动以测试各种检测功能</div>
      </div>
    </div>
  );
};
