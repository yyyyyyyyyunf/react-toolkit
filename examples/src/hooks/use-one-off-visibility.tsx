        ...
        >
          <AnimatedElement isVisible={isVisible4} delay={600}>
            ...
            >
              ...
              <div style={{ fontSize: '12px', opacity: 0.8 }}>(rootMargin: 100px)</div>
            </div>
          </AnimatedElement>
        </div>
      </section>
