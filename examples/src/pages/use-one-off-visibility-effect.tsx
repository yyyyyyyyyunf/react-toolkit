...
const UseOneOffVisibilityEffectExample: React.FC = () => {
  ...
  return (
    <div className="p-6 max-w-4xl mx-auto">
      <h1 className="text-3xl font-bold mb-8 text-center">useOneOffVisibilityEffect 示例</h1>
      ...
      <div className="space-y-8">
        ...
        <div ref={section1Ref} className="bg-green-100 p-8 rounded-lg border-2 border-green-300">
          <h3 className="text-lg font-semibold mb-4">Section 1 - 懒加载数据</h3>
          <p className="text-gray-700">
            当这个区域可见时（threshold: 0.5），会在控制台输出"Section 1 已可见，开始加载数据..."
          </p>
          <div className="mt-4 p-4 bg-white rounded border">
            <p className="text-sm text-gray-600">模拟内容区域 - 滚动页面查看效果</p>
          </div>
        </div>

        <div ref={section2Ref} className="bg-yellow-100 p-8 rounded-lg border-2 border-yellow-300">
          <h3 className="text-lg font-semibold mb-4">Section 2 - 动画触发</h3>
          <p className="text-gray-700">
            当这个区域可见时（默认配置），会在控制台输出"Section 2 已可见，触发动画..."
          </p>
          <div className="mt-4 p-4 bg-white rounded border">
            <p className="text-sm text-gray-600">模拟内容区域 - 滚动页面查看效果</p>
          </div>
        ...
        <div ref={section3Ref} className="bg-purple-100 p-8 rounded-lg border-2 border-purple-300">
          <h3 className="text-lg font-semibold mb-4">Section 3 - 分析事件</h3>
          <p className="text-gray-700">
            当这个区域可见时（threshold: 0.8, offset: 200），会在控制台输出"Section 3
            已可见，发送分析事件..."
          </p>
          <div className="mt-4 p-4 bg-white rounded border">
            <p className="text-sm text-gray-600">模拟内容区域 - 滚动页面查看效果</p>
