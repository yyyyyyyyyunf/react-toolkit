      ...
      <div className="example-section">
        ...
        {showPreloadDemo && (
          <div style={{ 
            ...
            <h4 style={{ color: '#fff', marginBottom: '0.5rem' }}>预加载队列预览：</h4>
            <PreloadQueueDemo />
          </div>
        )}
      </div>
...
const PreloadQueueDemo: React.FC = () => {
  const [preloadQueue, setPreloadQueue] = useState<any[]>([]);
  ...
  return (
    <div>
      ...
      <ul style={{ color: '#ccc', fontSize: '0.9rem', margin: 0, paddingLeft: '1rem' }}>
  ...
  return (
    <div>
      ...
      <ImageLoader 
        ...
        alt="动态切换"
        style={type === 'content' ? { width: '100%', height: 'auto' } : { width: '100%', height: '200px' }}
