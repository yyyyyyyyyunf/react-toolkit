import { type ElementPosition, useElementPosition, useScrollDirection } from '@fly4react/observer';
    ...
    <div style={{ overflow: 'hidden' }}>
      ...
      >
        ...
        >
          ...
          <p style={{ fontSize: '1.5rem', margin: 0 }}>向下滚动，感受视差魅力</p>
          <div
            style={{
              marginTop: '30px',
              fontSize: '14px',
      ...
      >
        ...
        >
          ...
          <p style={{ fontSize: '1.5rem', margin: 0 }}>背景反向移动的效果</p>
          <div
            style={{
              marginTop: '30px',
              display: 'flex',
      ...
      >
        ...
        >
          ...
          <p style={{ fontSize: '1.5rem', margin: 0 }}>多层元素协同运动</p>
