...
} from "@fly4react/feature-detector";
...
export default function FeatureDetectionExample() {
	const [detector] = useState(() =>
		createFeatureDetector(customFeatureConfigs),
	);
	...
	return (
		<div className="example-container">
			<h2>特性检测示例</h2>
			<p>
				使用 <code>@fly4react/feature-detector</code>{" "}
				检测浏览器对特定特性的支持情况。
			</p>
			...
			<div className="demo-section">
				...
				<div className="info-grid">
					...
					<div className="info-item">
						...
						<span
							className={
								browserInfo.useCache ? "status-enabled" : "status-disabled"
							}
						>
					...
					{browserInfo.browserInfo && (
						<>
							...
							<div className="info-item">
								...
								<span
									className={
										browserInfo.browserInfo.isWebView
											? "status-enabled"
											: "status-disabled"
									}
								>
							...
							{detailedResults[feature.name] && (
								<div className="feature-details">
									...
									<div className="detail-item">
										<strong>置信度：</strong>
										<span
											className={`confidence-${detailedResults[feature.name].confidence}`}
										>
								...
								<div className="result-details">
									...
									{customResult.browserInfo && (
										<div className="result-item">
											<strong>浏览器信息：</strong>
											<code>
												{customResult.browserInfo.name}{" "}
												{customResult.browserInfo.version}
											</code>
										</div>
									)}
								</div>
