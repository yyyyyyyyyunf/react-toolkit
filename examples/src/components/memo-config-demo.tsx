		...
		<div style={{ padding: "20px", fontFamily: "Arial, sans-serif" }}>
			...
			<div style={{ marginBottom: "30px" }}>
				...
				<div style={{ marginBottom: "20px" }}>
					...
					<div style={{ marginBottom: "10px" }}>
						...
						{getDebugComponents().length > 0
							? getDebugComponents().join(", ")
							: "无"}
					</div>
				</div>
			...
			>
				...
				<ul>
					<li>
						<strong>调试组件:</strong>{" "}
						当组件名称包含调试列表中的任何字符串时，会在控制台输出 props
						变化的调试日志
					</li>
					<li>
						<strong>忽略属性:</strong> 在比较 props
						时，这些属性会被自动忽略，不会触发重新渲染
					</li>
					<li>
						<strong>全局配置:</strong> 这是一个全局配置，适用于整个应用中的所有
						memo 组件
					</li>
					<li>
						<strong>简单注册:</strong> 只需要调用 registerDebugComponent 和
						registerIgnoreProp 即可
					</li>
				</ul>
			</div>
		</div>
