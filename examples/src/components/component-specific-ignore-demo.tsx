...
const ComponentSpecificIgnoreDemo: React.FC = () => {
	...
	const [componentIgnores, setComponentIgnores] = useState<
				...
				<div className="space-y-6">
					<div className="bg-blue-50 p-6 rounded-lg">
						...
						<ul className="list-disc list-inside space-y-2 text-gray-700">
							...
							<li>
								<strong>组件特定忽略：</strong>使用{" "}
								<code>registerComponentIgnoreProp</code>{" "}
								只忽略特定组件的特定属性
							</li>
							<li>
						...
						<div className="space-y-3">
							<div>
								...
								<div className="space-y-1">
									<button
										onClick={() =>
											handleComponentIgnore("UserCard", "lastLogin")
										}
							...
							<div>
								...
								<div className="space-y-1">
									<button
										onClick={() =>
											handleComponentIgnore("ProductCard", "description")
										}
										className="block w-full text-left px-3 py-2 bg-yellow-100 hover:bg-yellow-200 rounded text-sm"
									>
									...
									<button
										onClick={() =>
											handleComponentIgnore("ProductCard", "image")
										}
										className="block w-full text-left px-3 py-2 bg-yellow-100 hover:bg-yellow-200 rounded text-sm"
									>
