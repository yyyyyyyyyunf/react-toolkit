      ...
      <div style={{ 
        ...
        <div
          style={{
            width: `${percentage}%`,
            height: '100%',
            background: percentage > 66 ? '#28a745' : percentage > 33 ? '#ffc107' : '#dc3545',
  ...
  return (
    <div style={{ padding: '20px' }}>
        ...
        <div style={{ 
          ...
          <div style={{ background: '#f8f9fa', padding: '10px', borderRadius: '4px' }}>
            ...
            <div style={{ fontSize: '12px' }}>
              {intersectionRatio1 !== undefined ? `${(intersectionRatio1 * 100).toFixed(1)}%` : '未检测'}
            </div>
          </div>
          ...
          <div style={{ background: '#f8f9fa', padding: '10px', borderRadius: '4px' }}>
            ...
            <div style={{ fontSize: '12px' }}>
              {intersectionRatio2 !== undefined ? `${(intersectionRatio2 * 100).toFixed(1)}%` : '未检测'}
            </div>
          </div>
        </div>
      </div>
      ...
      <section style={{ marginBottom: '60px' }}>
        <h3>📐 边界矩形检测 1 (高频更新)</h3>
        <p style={{ color: '#666', fontSize: '14px' }}>step=0.1, throttle=16ms</p>
      ...
      <section style={{ marginBottom: '60px' }}>
        <h3>📊 交叉比例检测 1 (精确检测)</h3>
        <p style={{ color: '#666', fontSize: '14px' }}>step=0.05, throttle=8ms</p>
        
        <div
          ref={ratio1Ref}
          style={{
            height: '180px',
            background: intersectionRatio1 !== undefined
            ...
            fontWeight: 'bold',
            position: 'relative',
            opacity: intersectionRatio1 !== undefined ? 0.3 + intersectionRatio1 * 0.7 : 0.3,
            transform: intersectionRatio1 !== undefined 
        ...
        >
          ...
          <div style={{ fontSize: '24px', fontWeight: 'bold', marginTop: '10px' }}>
            {intersectionRatio1 !== undefined ? `${(intersectionRatio1 * 100).toFixed(1)}%` : '0%'}
          </div>
      ...
      <section style={{ marginBottom: '60px' }}>
        ...
        <p style={{ color: '#666', fontSize: '14px' }}>threshold=[0, 0.5, 1], throttle=33ms</p>
      ...
      <section style={{ marginBottom: '60px' }}>
        <h3>📊 交叉比例检测 2 (低频更新)</h3>
        <p style={{ color: '#666', fontSize: '14px' }}>step=0.2, throttle=100ms</p>
        
        <div
          ref={ratio2Ref}
          style={{
            height: '180px',
            background: intersectionRatio2 !== undefined
        ...
        >
          ...
          <div style={{ 
            ...
            {[0, 0.2, 0.4, 0.6, 0.8, 1].map((threshold, index) => (
              <div
                key={threshold}
                style={{
                  width: '15px',
                  height: '15px',
                  borderRadius: '50%',
                  background: intersectionRatio2 !== undefined && intersectionRatio2 >= threshold 
          ...
          <div style={{ 
            ...
            {intersectionRatio2 !== undefined ? `${(intersectionRatio2 * 100).toFixed(0)}%` : '0%'}
          </div>
        </div>
      </section>
